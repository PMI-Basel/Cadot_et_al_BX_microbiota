...
pdf("figures_review1/Fig_2_CAP_by_compartments.pdf", width=9, height=11)
Fig_all
noshow <- dev.off()
...
pdf("figures/Fig_3A_PCoA_background_legend.pdf", width=5, height=5)
...
# labels
pdf("figures_review1/Fig_3_CAP.pdf", width=10, height=9)
p
noshow <- dev.off()
...
pdf("figures_review1/Fig_4_Aurora_CAP.pdf", width=10, height=9)
p
noshow <- dev.off()
...
## plot
pdf("figures/Fig_3B_venn_root_fungi.pdf", width=4.5, height=4.5)
Fig_3B_venn_root_fungi <- venndiagram(fEDGER_Re_root_fit_genotype_lrt_table_OTUs, fEDGER_Re_root_fit_background_lrt_table_OTUs,
                         type="2", xpd=T, printsub=F, tcol="black", diacol="black",
                         labels=c("genotype","background"), title="Root fungi")
noshow <- dev.off()
...
## plot
pdf("figures_review1/Fig_3B_venn_percentSeq.pdf", width=10, height=2)
...
par(mar=c(1,1,1,1))
Au_rhizo_bacteria_venn <- venndiagram(bEDGER_Au_rhizo_fit_bx1_lrt_table_OTUs, bEDGER_Au_rhizo_fit_bx2_lrt_table_OTUs, bEDGER_Au_rhizo_fit_bx6_lrt_table_OTUs, 
...
# Au_rhizo_bacteria_venn

pdf("figures/Fig_4B_venn_rhizo_bacteria.pdf", width=4.5, height=4.5)
x <- venndiagram(bEDGER_Au_rhizo_fit_bx1_lrt_table_OTUs, bEDGER_Au_rhizo_fit_bx2_lrt_table_OTUs, bEDGER_Au_rhizo_fit_bx6_lrt_table_OTUs, 
                         type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
                         lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
                         labels=c(paste("WT-bx1 (", bEDGER_Au_rhizo_fit_bx1_lrt_table_OTUs_percent, "%)", sep=""),
                                  paste("WT-bx2 (", bEDGER_Au_rhizo_fit_bx2_lrt_table_OTUs_percent, "%)", sep=""),
                                  paste("WT-bx6 (", bEDGER_Au_rhizo_fit_bx6_lrt_table_OTUs_percent, "%)", sep="")), title="Rhizosphere bacteria")
noshow <- dev.off()
...
pdf("figures/Fig_4B_venn_rhizo_bacteria_percentSeq.pdf", width=4.5, height=4.5)
x <- venndiagram(bEDGER_Au_rhizo_fit_bx1_lrt_table_OTUs, bEDGER_Au_rhizo_fit_bx2_lrt_table_OTUs, bEDGER_Au_rhizo_fit_bx6_lrt_table_OTUs, 
type="3", xpd=T, printsub=F, tcol="black", diacol="black", lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
...
# source("functions/vennDia.R")
par(mar=c(1,1,1,1))
Au_rhizo_fungi_venn <- venndiagram(fEDGER_Au_rhizo_fit_bx1_lrt_table_OTUs, fEDGER_Au_rhizo_fit_bx2_lrt_table_OTUs, fEDGER_Au_rhizo_fit_bx6_lrt_table_OTUs, 
                                   type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
                                   lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
                                   labels=c("WT-bx1","WT-bx2","WT-bx6"), title="")
# Au_rhizo_fungi_venn

pdf("figures/Fig_4B_venn_rhizo_fungi.pdf", width=4.5, height=4.5)
...
## Plot percent seq
pdf("figures/Fig_4B_venn_rhizo_fungi_percentSeq.pdf", width=4.5, height=4.5)
x <- venndiagram(fEDGER_Au_rhizo_fit_bx1_lrt_table_OTUs, fEDGER_Au_rhizo_fit_bx2_lrt_table_OTUs, fEDGER_Au_rhizo_fit_bx6_lrt_table_OTUs, 
            type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
            lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
...
Au_root_bacteria_venn <- venndiagram(bEDGER_Au_root_fit_bx1_lrt_table_OTUs, bEDGER_Au_root_fit_bx2_lrt_table_OTUs, bEDGER_Au_root_fit_bx6_lrt_table_OTUs, 
                                   ...
                                   lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
                                   labels=c("WT-bx1","WT-bx2","WT-bx6"), title="")
# _Au_root_bacteria_venn

pdf("figures/Fig_4B_venn_root_bacteria.pdf", width=4.5, height=4.5)
x <- venndiagram(bEDGER_Au_root_fit_bx1_lrt_table_OTUs, bEDGER_Au_root_fit_bx2_lrt_table_OTUs, bEDGER_Au_root_fit_bx6_lrt_table_OTUs, 
            type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
            lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
            labels=c(paste("WT-bx1 (", bEDGER_Au_root_fit_bx1_lrt_table_OTUs_percent, "%)", sep=""),
                     paste("WT-bx2 (", bEDGER_Au_root_fit_bx2_lrt_table_OTUs_percent, "%)", sep=""),
                     paste("WT-bx6 (", bEDGER_Au_root_fit_bx6_lrt_table_OTUs_percent, "%)", sep="")), title="Root bacteria")
noshow <- dev.off()
...
pdf("figures/Fig_4B_venn_root_bacteria_percentSeq.pdf", width=4.5, height=4.5)
x <- venndiagram(bEDGER_Au_root_fit_bx1_lrt_table_OTUs, bEDGER_Au_root_fit_bx2_lrt_table_OTUs, bEDGER_Au_root_fit_bx6_lrt_table_OTUs, 
            type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
            lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
...
# source("functions/vennDia.R")
par(mar=c(1,1,1,1))
Au_root_fungi_venn <- venndiagram(fEDGER_Au_root_fit_bx1_lrt_table_OTUs, fEDGER_Au_root_fit_bx2_lrt_table_OTUs, fEDGER_Au_root_fit_bx6_lrt_table_OTUs, 
                                   type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
                                   lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
                                   labels=c("WT-bx1","WT-bx2","WT-bx6"), title="")
# Au_root_fungi_venn

pdf("figures/Fig_4B_venn_root_fungi.pdf", width=4.5, height=4.5)
x <- venndiagram(fEDGER_Au_root_fit_bx1_lrt_table_OTUs, fEDGER_Au_root_fit_bx2_lrt_table_OTUs, fEDGER_Au_root_fit_bx6_lrt_table_OTUs, 
            type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
            lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
            labels=c(paste("WT-bx1 (", fEDGER_Au_root_fit_bx1_lrt_table_OTUs_percent, "%)", sep=""),
                     paste("WT-bx2 (", fEDGER_Au_root_fit_bx2_lrt_table_OTUs_percent, "%)", sep=""),
                     paste("WT-bx6 (", fEDGER_Au_root_fit_bx6_lrt_table_OTUs_percent, "%)", sep="")), title="Root fungi")
noshow <- dev.off()
...
pdf("figures/Fig_4B_venn_root_fungi_percentSeq.pdf", width=4.5, height=4.5)
x <- venndiagram(fEDGER_Au_root_fit_bx1_lrt_table_OTUs, fEDGER_Au_root_fit_bx2_lrt_table_OTUs, fEDGER_Au_root_fit_bx6_lrt_table_OTUs, 
            type="3", xpd=T, printsub=F, tcol="black", diacol="black", 
            lcol=c("palegreen3", "palegreen1", "palegreen4"), lines=c("palegreen3", "palegreen1", "palegreen4"),
...
pdf("figures_review1/Fig_4B_venn_rhizo_bacteria_percentSeq.pdf", width=9, height=1.9)
par(mfrow=c(1,5), mar=c(0.2, 0.2, 1.2, 0.2))
...
pdf("figures_review1/Fig_5_S7_Maplot_legend.pdf", width=5, height=5)
...
pdf("figures_review1/Fig_5_S7_Venn_legend.pdf", width=5, height=5)
...
pdf("figures_review1/Fig_S8_Venn_BXsens_bOTUs_rhizo.pdf", width = 6, height = 3)
par(mfrow=c(1,2), mar=c(1,1,1,1))
Core_rhizo_bacteria_fams_enriched <- venndiagram(bEDGER_Ch_rhizo_BX_fit_lrt_table_fams_enriched, 
                                                 bEDGER_Au_rhizo_BX_fit_lrt_table_fams_enriched, 
                                                 bEDGER_Re_rhizo_BX_fit_lrt_table_fams_enriched, 
...
pdf("figures_review1/Fig_S8_Venn_BXsens_fOTUs_rhizo.pdf", width=6, height=3)
par(mfrow=c(1,2), mar=c(1,1,1,1))
Core_rhizo_fungi_fams_enriched <- venndiagram(fEDGER_Ch_rhizo_BX_fit_lrt_table_fams_enriched, 
                                                 fEDGER_Au_rhizo_BX_fit_lrt_table_fams_enriched, 
                                                 fEDGER_Re_rhizo_BX_fit_lrt_table_fams_enriched, 
...
pdf("figures_review1/Fig_S7_MAplot_rhizosphere_percentSeq.pdf", width=12, height=6)
par(mfrow=c(2,4), mar=c(4.5,4.5,1.6,1.6))
...
pdf("figures_review1/Fig_6_Venn_BXsens_bOTUs_root.pdf", width=6, height=3)
par(mfrow=c(1,2), mar=c(1,1,1,1))
Core_root_bacteria_fams_enriched <- venndiagram(bEDGER_Ch_root_BX_fit_lrt_table_fams_enriched, 
                                                 bEDGER_Au_root_BX_fit_lrt_table_fams_enriched, 
                                                 bEDGER_Re_root_BX_fit_lrt_table_fams_enriched, 
...
pdf("figures_review1/Fig_6_Venn_BXsens_fOTUs_root.pdf", width=6, height=3)
par(mfrow=c(1,2), mar=c(1,1,1,1))
Core_root_fungi_fams_enriched <- venndiagram(fEDGER_Ch_root_BX_fit_lrt_table_fams_enriched, 
                                                 fEDGER_Au_root_BX_fit_lrt_table_fams_enriched, 
...
```{r Fig 5 MAplot all locations root bacteria and fungi WT vs bx1 rev 1, fig.height=5, fig.width=15, warning=F, echo=F, results="hide"}
# custom function fun_maplot() to plot edgeR results as MA-plots
# source("functions/fun_maplot.R")
...
pdf("figures_review1/Fig_5AB_MAplot_root_percentSeq.pdf", width=12, height=6)
...
pdf("figures_review1/Fig_5C_rhizosphere_vs_root.pdf", width=12, height=4)
par(mfrow=c(2,4), mar=c(4.5,4.5,1.6,1.6))
...
FUNGuild_dat <- read.delim("FUNGuild/fotutable_tmm_ra.guilds-1.txt", row.names=1,  head=T, "\t")
